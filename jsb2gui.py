    ...
    def on_action_Open_triggered(self, checked=None):
        ...
        if file_name:
            ...
            pkgs = QTreeWidgetItem(\
                [u'pkgs', '[%i packages]' % len(jsb2['pkgs'])])
            ...
            num_res = '[%i resources]' % len(jsb2['resources'])
